...
public final class GradleTools {  
     ...
     * @return 执行结果 
     */  
    public String toEclipseProject(String rootProjectDir, String subProjectName) {
     ...
     * @return 执行结果 
     */  
    public String addProjectEClassPath(String rootProjectDir, String subProjectName) {
     ...
     * @return 执行结果 
     */  
    public String jar(String rootProjectDir, String subProjectName) {
     ...
     * @return 执行结果 
     */  
    public String execute(File projectDir, List<String> arguments, Map<String, String> jvmDefines, String... tasks) {
